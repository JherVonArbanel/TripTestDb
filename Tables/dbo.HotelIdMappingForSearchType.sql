CREATE TABLE [dbo].[HotelIdMappingForSearchType]
(
...
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex_PkId_Type] ON [dbo].[HotelIdMappingForSearchType] ([pkId], [type]) ON [PRIMARY]
GO
