...
CREATE VIEW [dbo].[vw_sabreCarResponse]
AS
...
EXEC sp_addextendedproperty N'MS_DiagramPane2', N'              Bottom = 480
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_sabreCarResponse', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_sabreCarResponse', NULL, NULL
GO
