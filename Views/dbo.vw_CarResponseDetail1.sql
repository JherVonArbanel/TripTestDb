...
SET ANSI_NULLS ON
GO
 Create view [dbo].[vw_CarResponseDetail1]
 AS
 SELECT dbo.CarResponse.carRequestKey, dbo.CarResponse.carVendorKey, CarVendorLookup.carVendorName,
dbo.CarResponse.supplierId, dbo.CarResponse.carCategoryCode,
dbo.CarResponse.carLocationCode, dbo.CarResponse.carLocationCategoryCode, dbo.CarResponse.minRate AS PerDayRate,
CarContent.dbo.SabreVehicles.VehicleName, SabreLocations_1.LocationName AS pickupLocationName,
SabreLocations_1.LocationAddress1 AS pickupLocationAddress, SabreLocations_1.Latitude AS pickupLatitude,
...
dbo.CarResponse.RatePlan
  FROM CarContent.dbo.CarCompanies
INNER JOIN dbo.CarResponse
LEFT OUTER JOIN CarVendorLookup ON CarResponse.CarVendorKey = CarVendorLookup.carVendorCode
INNER JOIN CarContent.dbo.SippCodes ON dbo.CarResponse.carCategoryCode = CarContent.dbo.SippCodes.SippCodeCarType
ON CarContent.dbo.CarCompanies.CarCompanyCode = dbo.CarResponse.carVendorKey
LEFT OUTER JOIN CarContent.dbo.SabreLocations
LEFT OUTER JOIN CarContent.dbo.SabreVehicles ON CarContent.dbo.SabreLocations.VendorCode = CarContent.dbo.SabreVehicles.VendorCode AND
...
ON dbo.CarResponse.carVendorKey = CarContent.dbo.SabreVehicles.VendorCode AND
dbo.CarResponse.carCategoryCode = CarContent.dbo.SabreVehicles.SippCode AND
dbo.CarResponse.carLocationCode = CarContent.dbo.SabreVehicles.LocationAirportCode AND
dbo.CarResponse.carLocationCategoryCode = CarContent.dbo.SabreVehicles.LocationCategoryCode
LEFT OUTER JOIN dbo.CarRequest ON dbo.CarResponse.carRequestKey = dbo.CarRequest.carRequestKey
GO
