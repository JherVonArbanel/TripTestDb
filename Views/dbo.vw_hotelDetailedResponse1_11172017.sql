...
CREATE VIEW [dbo].[vw_hotelDetailedResponse1_11172017]  
AS  
SELECT     HR.hotelResponseKey, HR.supplierHotelKey, HR.hotelRequestKey, HR.supplierId, HR.minRate, HT.HotelName, HT.Rating, HT.RatingType, HT.ChainCode, HT.HotelId,   
                      HT.Latitude, HT.Longitude, HT.Address1, HT.CityName, HT.StateCode, HT.CountryCode, HT.ZipCode, HT.PhoneNumber, HT.FaxNumber, ISNULL(HT.cityCode,   
                      ...
                      HC.ChainName, HR.minRateTax, ISNULL(HotelContent.dbo.HotelImages_Exterior.SupplierImageURL, CHI.ImageURL) AS ImageURL, HR.preferenceOrder, HR.corporateCode,   
                      ...
                      dbo.HotelDescription.checkOutTime, HT.richMediaUrl,PR.RegionID,PR.RegionName
      ...
      Begin Tables = 
         ...
         Begin Table = "HQ"
            Begin Extent = 
               ...
               Right = 434
            End
            DisplayFlags ', 'SCHEMA', N'dbo', 'VIEW', N'vw_hotelDetailedResponse1_11172017', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N'= 280
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_hotelDetailedResponse1_11172017', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_hotelDetailedResponse1_11172017', NULL, NULL
GO
