...
CREATE PROCEDURE [dbo].[USP_GetAirResponsesMultiCityInternational_New]
(
--DECLARE	
...
/******/
	...
	(
		...
		airSegmentClassEconSaver	VARCHAR(20),
		airSegmentClassEconFlex		VARCHAR(20),
		airSegmentClassCorporate	VARCHAR(20),
		airSegmentClassEconUpgrade	VARCHAR(20),
		airSegmentClassSuperSaver	VARCHAR(20),
		airSegmentClassFirstFlex	VARCHAR(20),
		airsegmentEconomySeatRemaining			INT,
		airsegmentPremiumEconomySeatRemaining	INT,
		airsegmentBusinessSeatRemaining			INT,
		airsegmentPremiumBusinessSeatRemaining	INT,
		airsegmentFirstSeatRemaining			INT,
		airsegmentPremiumFirstSeatRemaining		INT,
	)

	INSERT INTO #AirSegments ( airSegmentKey,airResponseKey,airLegNumber,airSegmentMarketingAirlineCode,airSegmentOperatingAirlineCode,airSegmentFlightNumber,airSegmentDuration,airSegmentEquipment,airSegmentMiles,airSegmentDepartureDate,airSegmentArrivalDate,airSegmentDepartureAirport,airSegmentArrivalAirport,airSegmentResBookDesigCode,airSegmentDepartureOffset,airSegmentArrivalOffset ,airSegmentSeatRemaining,airSegmentMarriageGrp ,airFareBasisCode ,airFareReferenceKey ,airSegmentOperatingFlightNumber,airsegmentCabin ,segmentOrder,airSegmentOperatingAirlineCompanyShortName,airSegmentClassEconSaver,airSegmentClassEconFlex,airSegmentClassCorporate,
		airSegmentClassEconUpgrade	,	airSegmentClassSuperSaver	,	airSegmentClassFirstFlex	,	airsegmentEconomySeatRemaining	,
		airsegmentPremiumEconomySeatRemaining,airsegmentBusinessSeatRemaining	,airsegmentPremiumBusinessSeatRemaining	,airsegmentFirstSeatRemaining,airsegmentPremiumFirstSeatRemaining)
	(
		...
		airSegmentClassEconSaver,airSegmentClassEconFlex,airSegmentClassCorporate,airSegmentClassEconUpgrade	,	airSegmentClassSuperSaver	,	airSegmentClassFirstFlex	,	airsegmentEconomySeatRemaining	,
		airsegmentPremiumEconomySeatRemaining,airsegmentBusinessSeatRemaining	,airsegmentPremiumBusinessSeatRemaining	,airsegmentFirstSeatRemaining,airsegmentPremiumFirstSeatRemaining
	 ...
	 END
 		...
 		,airSuperSaverTax,airEconSaverTax,airFirstFlexTax,airCorporateTax,airEconFlexTax,airEconUpgradeTax, economyRefundable,premiumEconomyRefundable,businessRefundable,premiumBusinessRefundable,firstRefundable,premiumFirstRefundable,airsegmentClassEconomy,airsegmentClassPremiumEconomy,airsegmentClassBusinessCabin,airsegmentClassPremiumBusinessCabin,airsegmentClassFirstCabin,airsegmentClassPremiumFirstCabin)  
		   ...
		   otherlegPrice ,refundable, isBrandedFare, normalized.cabinclass ,fareType,segmentOrder ,seg.airsegmentCabin,(isnull(normalized.airPriceBase,0) + ISNULL (normalized.airpriceTax,0) ),seg.airSegmentOperatingFlightNumber,otherlegtax, airPriceBaseSenior,airPriceTaxSenior,airPriceBaseChildren,airPriceTaxChildren,airPriceBaseInfant,airPriceTaxInfant,airPriceBaseYouth,airPriceTaxYouth,AirPriceBaseTotal,AirPriceTaxTotal,airPriceBaseDisplay, airPriceTaxDisplay, seg.airSegmentOperatingAirlineCompanyShortName,
			...
			seg.airSegmentClassEconSaver as airsegmentClassEconomy,seg.airSegmentClassEconFlex as airsegmentClassPremiumEconomy,seg.airSegmentClassCorporate as airsegmentClassBusinessCabin,
			seg.airSegmentClassEconUpgrade as airsegmentClassPremiumBusinessCabin,seg.airSegmentClassSuperSaver as airsegmentClassFirstCabin,seg.airSegmentClassFirstFlex as airsegmentClassPremiumFirstCabin
