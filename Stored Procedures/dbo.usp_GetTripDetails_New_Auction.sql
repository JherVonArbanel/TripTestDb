...
/*Exec usp_GetTripDetails_New_Auction 4202,0*/  
CREATE PROCEDURE [dbo].[usp_GetTripDetails_New_Auction]          
(      
 @tripID   int   ,        
 @tripRequestID Int = 0        
)      
...
select Trip.* , vault.dbo.Agency .agencyKey As Agency_ID, U.*, TR.tripAdultsCount, isnull(TR.tripChildrenCount,0) as airRequestChildren from Trip         
...
Inner Join TripRequest TR on  TR.tripRequestKey = tt.RequestKey          
Order by tripKey         
