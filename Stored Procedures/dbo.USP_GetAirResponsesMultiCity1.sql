...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[USP_GetAirResponsesMultiCity1]  
(  
...
Delete P  
 ...
 (  
  ...
  WHERE airLegNumber = @airRequestTypeKey  
  GROUP BY seg.airResponseKey,result.airOnePriceBaseDisplay ,gdssourcekey  ,result .airOnePriceTaxDisplay , result.airsubRequestkey ,otherlegprice ,result .cabinclass   ,otherlegtax   
