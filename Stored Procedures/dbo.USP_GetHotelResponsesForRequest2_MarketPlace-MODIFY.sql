 ...
 **********************************/              
CREATE PROCEDURE [dbo].[USP_GetHotelResponsesForRequest2_MarketPlace-MODIFY]    
(     
--declare     
 @hotelRequestKey  INT,    
...
BEGIN  
  ...
  SELECT FHR.hotelResponseKey,FHR.supplierHotelKey,FHR.hotelRequestKey,FHR.SupplierId,FHR.minRate,HT.HotelName,HT.Rating,HT.RatingType, FHR.corporateCode, FHR.preferenceOrder,  
   ISNULL(HT.ChainCode,FHR.HotelId),FHR.HotelId,HT.Latitude,HT.Longitude,HT.Address1,HT.CityName,HT.StateCode,HT.CountryCode,HT.ZipCode,'','',HT.CityCode,   
   '',  
   0,  
   null,null,  
   '',  
