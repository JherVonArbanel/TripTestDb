...
--Exec USP_GetTripSavedDealHotelMinPrice 76136,1
CREATE PROCEDURE [dbo].[USP_GetTripSavedDealHotelMinPrice_2]
...
BEGIN
	...
	,VW_SHR.Rating,VW_SHR.RatingType,VW_SHR.ZipCode,HR.corporateCode,VW_SHR.HotelId,VW_SHR.Latitude,VW_SHR.Longitude
	From HotelResponse HR With (NoLock) Inner Join vw_hotelDetailedResponseDeals VW_SHR With (NoLock)
	...
	Declare @insertCount int
			...
			--,@CurrentTouricoId VARCHAR(10)
			--,@CurrentSabreHotelId VARCHAR(10)
			...
			BEGIN
				...
				BEGIN
					...
					Begin
						...
						,vendorDetails,originalTotalPrice,Remarks)
				...
				BEGIN TRY
					...
					SELECT @HotelName = HotelName, @HotelRatingTMU = Rating, @HotelChainCode = ChainCode 
