...
CREATE PROCEDURE [dbo].[spClearOneHrBeforeTripResponses_demo]
(
	@siteKey	INT
)	
AS 
...
-- PRINT 'INSERT TRIPREQUEST'
	...
	INSERT INTO @HrBeforeTripReqKey
	SELECT tripRequestKey FROM TripRequest WHERE tripRequestCreated < DATEADD(MINUTE, -30, GETDATE())
