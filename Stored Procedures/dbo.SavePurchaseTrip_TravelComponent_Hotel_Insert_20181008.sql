...
-- =============================================
CREATE PROCEDURE [dbo].[SavePurchaseTrip_TravelComponent_Hotel_Insert_20181008]
...
BEGIN
	...
	INSERT INTO TripHotelResponse (hotelResponseKey, tripGUIDKey, supplierHotelKey, supplierId, minRate, minRateTax, hotelDailyPrice, hotelDescription,
						...
						AverageBaseRate, PromoId, MarketplaceMarginPercent, estimatedRefundAmount, DepositAmount, HotelId)
