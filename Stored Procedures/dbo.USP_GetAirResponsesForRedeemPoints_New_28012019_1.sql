...
CREATE PROCEDURE [dbo].[USP_GetAirResponsesForRedeemPoints_New_28012019_1]
	(   
 ...
 --   IF (@isMultiBrand=1)
	...
	BEGIN
		...
		and ISNULL(resp.gdsSourceKey,13) =( Case WHEN @gdssourcekey = 0 THEN ISNULL(resp.gdsSourceKey ,13) ELSE 13 END )
		select '1'
		select '11',* from #AllOneWayResponses
	--select * from #AllOneWayResponses
		...
		select '8',* from #AllOneWayResponses
		return
