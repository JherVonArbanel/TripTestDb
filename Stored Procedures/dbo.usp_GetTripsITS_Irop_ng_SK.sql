...
create PROCEDURE [dbo].[usp_GetTripsITS_Irop_ng_SK] 
--DECLARE
...
--select 
-- @SiteGUID=N'68596B78-C7CE-4DB6-BBA9-FF16BCB95853'
-- ,@CompanyGUID=N'EE1AE673-F50B-4FED-BE97-4791E4F2DD95',@UserGUID=N'DA511157-6885-49C6-81E5-07694FEBAFA4',@PageName=N'pasttrips',@PNR=NULL,@UDIDandValue=NULL,@StartDate=N'1/5/2017 12:00:00 AM',@EndDate=N'2/4/2019 12:00:00 AM',@SearchUsers=N'570467,570500'
--exec usp_GetTripsITS_Irop_ng @SiteGUID=N'764D1324-B6F4-4B07-9C91-11AE6427857E',@CompanyGUID=N'C35EE307-0B2D-4F25-AE60-52B239BEFCB4',@UserGUID=N'B6A4F4B8-456D-47A6-85C6-69EDC9D45C91',@PageName=N'activetrips',@PNR=N'',@UDIDandValue=NULL,@StartDate=NULL,@EndDate=NULL
--SELECT @SiteGUID=N'68596B78-C7CE-4DB6-BBA9-FF16BCB95853'
--,@CompanyGUID=4919
--,@UserGUID=N'4290F0A8-F9BB-481F-822D-97562EE45710',@PageName=N'pasttrips',@PNR=N'',@UDIDandValue=NULL
--,@StartDate='2017-11-01 00:00:00.000',@EndDate='2017-12-19 00:00:00.000'

--SELECT @SiteGUID=N'764D1324-B6F4-4B07-9C91-11AE6427857E',@CompanyGUID=N'1058DD73-4292-4E3D-BA11-99C7207DE502'
--,@UserGUID=N'A252586E-ED80-443F-BDB9-01AC3F7738E6'
--,@PageName=N'activetrips-events',@PNR=N'',@UDIDandValue=NULL,@StartDate=NULL,@EndDate=NULL

-- SELECT @SiteGUID=N'C13A7817-92AA-4CB0-BDA1-C4BAD3B11F0F',@CompanyGUID=N'4CB134CD-6C48-40AF-BBD2-2EA1F0802B5B',@UserGUID=N'5568CD20-A7F3-4535-BF1B-AB7E66863F72',@PageName=N'pasttrips',@PNR=N'',@UDIDandValue=NULL,@StartDate=N'14-May-17',@EndDate=N'15-May-17'
BEGIN
/* To Be Removed - Start */
...
--	LEFT OUTER JOIN Trip.dbo.TripRequest TR ON trip.TripRequestKey = TR.tripRequestKey
	...
	FROM	#tmpTrip T
	 ...
	 --UPDATE T SET T.NoOfStops=1, T.DepartTime='6:23P' ,T.ArrivalTime='8:55P'--,HotelName='Hilton Chicago'	,StarRating=4,
	...
	(
		SELECT 
			T.tripkey, COUNT(seg.airresponsekey)-1 as NoOfStops,CONVERT(VARCHAR(10),MIN(airSegmentDepartureDate),108) DepartTime,
			CONVERT(VARCHAR(10),MAX(airSegmentArrivalDate),108) ArrivalTime
