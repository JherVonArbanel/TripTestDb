...
CREATE PROCEDURE [dbo].[usp_GetTripDetailsForMultipax_Local] 
(                      
--DECLARE
 @tripID   int   ,                        
 @tripRequestID Int = 0                        
...
SELECT TD.tripKey, TD.recordLocator, carResponseKey, confirmationNumber, carVendorKey, supplierId, carCategoryCode, carLocationCode, carLocationCategoryCode
