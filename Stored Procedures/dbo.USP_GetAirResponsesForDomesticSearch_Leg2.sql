...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[USP_GetAirResponsesForDomesticSearch_Leg2]
	(  
		...
		/**airLEg > 1 **/  
			...
			BEGIN  
				...
				BEGIN  
					...
					If(@isMultiBrand = 1 AND @SelectedResponseMultiBrandKey  IS NOT NULL AND @SelectedResponseMultiBrandKey <> '{00000000-0000-0000-0000-000000000000}')  
						BEGIN
...
--return
			...
			BEGIN    
				...
				--select 'Airline',* from @multiLegPrice
			END   
			ELSE   
			BEGIN  
				INSERT @multiLegPrice (airPriceBase,airPriceTax,airPriceBaseSenior,airPriceTaxSenior,airPriceBaseChildren,airPriceTaxChildren,airPriceBaseInfant,airPriceTaxInfant,airPriceBaseYouth,airPriceTaxYouth,AirPriceBaseTotal,AirPriceTaxTotal ,airPriceBaseDisplay,airPriceTaxDisplay,airPriceBaseInfantWithSeat,airPriceTaxInfantWithSeat)  
...
--return
	...
	BEGIN  
		...
		BEGIN  
		--select @airPriceForAnotherLeg,@airPriceTaxForAnotherLeg
