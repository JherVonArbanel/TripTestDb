...
-- EXEC [USP_GetRecentPurchaseCrowd] 561393, 5            
CREATE PROCEDURE [dbo].[USP_GetRecentPurchaseCrowd]            
(            
@UserKey INT,            
@SiteKey INT            
)            
...
INSERT @tblPurchase(tripKey,tripPurchasedKey)            
 ...
 AND (tripStatusKey = 2 OR tripStatusKey = 1 OR tripStatusKey = 15 OR tripStatusKey =5) -- 1 = Pending | 2 = Purchased | 15 = Partial Purchase --      
 ORDER BY 1 DESC            
...
SELECT  T.[tripKey],[tripName],T.[userKey],[recordLocator],[tripStatusKey],[tripSavedKey],T.[tripPurchasedKey]            
   ...
   CASE           
     ...
     dbo.getImageURLFromCityCode(TR.tripTo1) as [ImageUrl]
 INTO #tmpTrip                 
