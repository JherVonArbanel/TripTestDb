...
CREATE PROCEDURE [dbo].[USP_GetAirResponsesForDomesticSearch_UnificationChange]
	(  
...
--SELECT 'Normalized',* from #normalizedResultSet
	...
	,airSuperSaverTax,airEconSaverTax,airFirstFlexTax,airCorporateTax,airEconFlexTax,airEconUpgradetax,resp.airPriceBaseInfantWithSeat,resp.airPriceTaxInfantWithSeat,agentwareQueryID,agentwareItineraryID,airsegmentPricingKey,airSegmentFareCategory,normalized.airLegBrandName,seg.airSegmentBrandName,seg.airSegmentBrandID,seg.airSegmentBaggage,seg.airSegmentMealCode
