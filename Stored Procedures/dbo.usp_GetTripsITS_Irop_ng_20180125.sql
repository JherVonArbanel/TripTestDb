...
CREATE PROCEDURE [dbo].[usp_GetTripsITS_Irop_ng_20180125] 
--DECLARE
...
--select @SiteGUID=N'0BB30C66-FB43-4B7E-BAB8-B0F3064618D9',@CompanyGUID=N'21FEBFAF-8C2E-4627-8FF3-D2962166A45B',@UserGUID=N'BF6C193E-E7F2-4787-A936-5272FE4FA8CF',@PageName=N'mytrips',@PNR=NULL,@UDIDandValue=NULL,@StartDate=N'1/9/2018 12:00:00 AM',@EndDate=N'1/16/2018 12:00:00 AM',@SearchUsers=N''
BEGIN
/* To Be Removed - Start */
...
Print 'Inside @RoleTripId'
	...
	,NULL LocationImage,NULL UserImage,NULL ComponentType
...
--	LEFT OUTER JOIN Trip.dbo.TripRequest TR ON trip.TripRequestKey = TR.tripRequestKey
	...
	FROM	#tmpTrip T
	 ...
	 BEGIN
		...
		--ALTER TABLE #tmpTrip ADD TripTo_1 VARCHAR(10)
     
		--UPDATE T
		--SET	TripTo_1 = TR.TripTo1 
		--FROM #tmpTrip T
		--	INNER JOIN Trip.dbo.TripRequest TR ON T.tripRequestKey = TR.tripRequestKey
