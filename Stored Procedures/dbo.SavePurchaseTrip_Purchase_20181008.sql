...
-- =============================================
CREATE PROCEDURE [dbo].[SavePurchaseTrip_Purchase_20181008] 
...
BEGIN TRY
	...
	INSERT INTO [dbo].[Trip] ([tripPurchasedKey],[tripSavedKey],[tripName],[userKey],[recordLocator],[tripStatusKey] ,[agencyKey],tripComponentType,tripRequestKey,
		...
		IsRequestApproval,ApproverEmailAddresses,IsRequestNotification, NotificationEmailAddresses,ApprovalReasons,NotificationReasons,BackupApproverEmails,AdvantageNumber,CartNumber)
