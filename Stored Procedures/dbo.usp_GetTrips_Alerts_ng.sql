...
CREATE PROCEDURE [dbo].[usp_GetTrips_Alerts_ng] 
--DECLARE
...
--SELECT @SiteGUID=N'0BB30C66-FB43-4B7E-BAB8-B0F3064618D9',@CompanyGUID=N'D28F73CB-2443-4273-839A-A5B7AA290DDD'
--	,@UserGUID=N'F565F30D-BBAF-44AD-90F9-CA26A5C4E93B',@PageName=N'mytrips',@PNR=NULL,@UDIDandValue=NULL,@StartDate=N''
--	,@EndDate=N'',@SearchUsers=N''

--SELECT @SiteGUID=N'764D1324-B6F4-4B07-9C91-11AE6427857E',@CompanyGUID=N'89D23DDB-0594-49D5-90B5-8DA4DF75206A'
--	,@UserGUID=N'6CC406CB-2D1D-438B-B3AE-0FF5B223480E',@PageName=N'mytrips',@PNR=N'',@UDIDandValue=NULL,@StartDate=NULL
--	,@EndDate=NULL
...
Print 'Inside @RoleTripId'
	...
	AND S.tripStatusKey=7
	AND trip.ISSUEDATE >=DATEADD(HOUR, -24, getdate()) 
...
--SELECT 'Delete this-#tmpTrip', * FROM #tmpTrip WHERE tripKey = 1951

--SELECT 'Delete this-#tbl_vw_TripDetails_tripaudit', * FROM #tbl_vw_TripDetails_tripaudit 
--WHERE recordLocator IN ('YUJDZH', 'GOUXSH')
...
--	LEFT OUTER JOIN Trip.dbo.TripRequest TR ON trip.TripRequestKey = TR.tripRequestKey
	...
	(
		SELECT 
			T.tripkey, COUNT(seg.airresponsekey)-1 as NoOfStops,SUBSTRING(CONVERT(VARCHAR,MIN(airSegmentDepartureDate),100),13,6) DepartTime,
