...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[USP_GetAirResponsesForDomesticSearch_upsell]
	(  
...
--return
	...
	BEGIN   
		...
		BEGIN
			...
			and ISNULL(resp.gdsSourceKey,2) =( Case WHEN @gdssourcekey = 0 THEN ISNULL(resp.gdsSourceKey ,2) ELSE @gdssourcekey END ) 
		END
		select 'RT',* from #AllOneWayResponses
		
				
		--AgentWare Responses for WN
		IF(@airRequestType <> 1)
		BEGIN
			INSERT #AllOneWayResponses (airOneResponsekey,airOnePriceBase,airOnePriceBaseSenior,airOnePriceTaxSenior,airOnePriceBaseChildren,airOnePriceTaxChildren,airOnePriceBaseInfant,airOnePriceTaxInfant,airOnePriceBaseYouth,airOnePriceTaxYouth,airOnePriceBaseTotal,airOnePriceTaxTotal,airOnePriceBaseDisplay, airOnePriceTaxDisplay,airSegmentFlightNumber,airSegmentMarketingAirlineCode,airsubRequestkey,airOnePriceTax ,airpriceTotal,otherLegprice,cabinclass  ,otherlegtax ,legConnections ,airOnePriceBaseInfantWithSeat,airOnePriceTaxInfantWithSeat,agentwareQueryID,agentwareItineraryID,airLegBrandName,gdsSourceKey,childResponsekey)  
			...
			(airPriceBaseInfantWithSeat + ISNULL(@airPriceInfantWithSeatForAnotherLeg,0)  ),(airPriceTaxInfantWithSeat + ISNULL(@airPriceTaxInfantWithSeatForAnotherLeg,0)),agentwareQueryID,agentwareItineraryID,n.airLegBrandName,ISNULL(resp.gdsSourceKey,2) ,resp.airresponsekey
			...
			IF(@isMultiBrand = 1)
			BEGIN
				INSERT #AllOneWayResponses (airOneResponsekey,airOnePriceBase,airOnePriceBaseSenior,airOnePriceTaxSenior,airOnePriceBaseChildren,airOnePriceTaxChildren,airOnePriceBaseInfant,airOnePriceTaxInfant,airOnePriceBaseYouth,airOnePriceTaxYouth,airOnePriceBaseTotal,airOnePriceTaxTotal,airOnePriceBaseDisplay, airOnePriceTaxDisplay,airSegmentFlightNumber,airSegmentMarketingAirlineCode,airsubRequestkey,airOnePriceTax ,airpriceTotal,otherLegprice,cabinclass  ,otherlegtax ,legConnections ,airOnePriceBaseInfantWithSeat,airOnePriceTaxInfantWithSeat,agentwareQueryID,agentwareItineraryID,airLegBrandName, airLegBookingClasses,airResponseMultiBrandKey,isMultiBrandFare,gdsSourceKey,childResponsekey)  
...
--return
	...
	BEGIN  
		IF(@isMultiBrand = 1)
		BEGIN
			INSERT #AllOneWayResponses (airOneResponsekey,airOnePriceBase,airOnePriceBaseSenior,airOnePriceTaxSenior,airOnePriceBaseChildren,airOnePriceTaxChildren,airOnePriceBaseInfant,airOnePriceTaxInfant,airOnePriceBaseYouth,airOnePriceTaxYouth,airOnePriceBaseTotal,airOnePriceTaxTotal,airOnePriceBaseDisplay, airOnePriceTaxDisplay,airSegmentFlightNumber,airSegmentMarketingAirlineCode,airsubRequestkey,airOnePriceTax ,airpriceTotal,otherLegprice,cabinclass  ,otherlegtax ,legConnections,airOnePriceBaseInfantWithSeat,airOnePriceTaxInfantWithSeat,airLegBrandName,airLegBookingClasses,gdsSourceKey,childResponsekey)  
			SELECT resp.airresponsekey, (airPriceBase + ISNULL(@airPriceForAnotherLeg,0)  ),
			(airPriceBaseSenior + ISNULL(@airPriceSeniorForAnotherLeg,0)  ),(airPriceTaxSenior + ISNULL(@airPriceTaxSeniorForAnotherLeg,0)),
			(airPriceBaseChildren + ISNULL(@airPriceChildrenForAnotherLeg,0)  ),(airPriceTaxChildren + ISNULL(@airPriceTaxChildrenForAnotherLeg,0)),
			(airPriceBaseInfant + ISNULL(@airPriceInfantForAnotherLeg,0)  ),(airPriceTaxInfant + ISNULL(@airPriceTaxInfantForAnotherLeg,0)),
			...
			flightNumber,airlines,resp .airSubRequestKey ,(airPriceTax + ISNULL(@airPriceTaxForAnotherLeg,0)),(airPriceBase + ISNULL(@airPriceForAnotherLeg,0)  )+(airPriceTax + ISNULL
			(@airPriceTaxForAnotherLeg,0)), case when @isTotalPriceSort = 0 THEN  ISNULL(@airPriceForAnotherLeg,0) else( isnull(@airPriceForAnotherLeg ,0) + isnull(@airPriceTaxForAnotherLeg,0) ) END ,N.cabinclass ,isnull(@airPriceTaxForAnotherLeg,0)  ,n.airLegConnections,
			(airPriceBaseInfantWithSeat + ISNULL(@airPriceInfantWithSeatForAnotherLeg,0)  ),(airPriceTaxInfantWithSeat + ISNULL(@airPriceTaxInfantWithSeatForAnotherLeg,0)),n.airLegBrandName,n.airLegBookingClasses,ISNULL(resp.gdsSourceKey,2),resp.AirResponsekey
			...
			and ISNULL(resp.gdsSourceKey,2) = (Case WHEN @gdssourcekey = 0 THEN ISNULL(resp.gdsSourceKey,2) ELSE @gdssourcekey END )  
			select 'OW Original',* from #AllOneWayResponses
			INSERT #AllOneWayResponses (airOneResponsekey,airOnePriceBase,airOnePriceBaseSenior,airOnePriceTaxSenior,airOnePriceBaseChildren,airOnePriceTaxChildren,airOnePriceBaseInfant,airOnePriceTaxInfant,airOnePriceBaseYouth,airOnePriceTaxYouth,airOnePriceBaseTotal,airOnePriceTaxTotal,airOnePriceBaseDisplay, airOnePriceTaxDisplay,airSegmentFlightNumber,airSegmentMarketingAirlineCode,airsubRequestkey,airOnePriceTax ,airpriceTotal,otherLegprice,cabinclass  ,otherlegtax ,legConnections,airOnePriceBaseInfantWithSeat,airOnePriceTaxInfantWithSeat,airLegBrandName, airLegBookingClasses,airResponseMultiBrandkey,isMultiBrandFare,gdsSourceKey,childResponsekey)  
			SELECT resp.airresponsekey, (airPriceBase + ISNULL(@airPriceForAnotherLeg,0)  ),
			(airPriceBaseSenior + ISNULL(@airPriceSeniorForAnotherLeg,0)  ),(airPriceTaxSenior + ISNULL(@airPriceTaxSeniorForAnotherLeg,0)),
			(airPriceBaseChildren + ISNULL(@airPriceChildrenForAnotherLeg,0)  ),(airPriceTaxChildren + ISNULL(@airPriceTaxChildrenForAnotherLeg,0)),
			(airPriceBaseInfant + ISNULL(@airPriceInfantForAnotherLeg,0)  ),(airPriceTaxInfant + ISNULL(@airPriceTaxInfantForAnotherLeg,0)),
			...
			flightNumber,airlines,resp .airSubRequestKey ,(airPriceTax + ISNULL(@airPriceTaxForAnotherLeg,0)),(airPriceBase + ISNULL(@airPriceForAnotherLeg,0)  )+(airPriceTax + ISNULL
			(@airPriceTaxForAnotherLeg,0)), case when @isTotalPriceSort = 0 THEN  ISNULL(@airPriceForAnotherLeg,0) else( isnull(@airPriceForAnotherLeg ,0) + isnull(@airPriceTaxForAnotherLeg,0) ) END ,N.cabinclass ,isnull(@airPriceTaxForAnotherLeg,0)  ,n.airLegConnections,
			(airPriceBaseInfantWithSeat + ISNULL(@airPriceInfantWithSeatForAnotherLeg,0)  ),(airPriceTaxInfantWithSeat + ISNULL(@airPriceTaxInfantWithSeatForAnotherLeg,0)),n.airLegBrandName,n.airLegBookingClasses,resp.airResponseMultiBrandKey,1,ISNULL(resp.gdsSourceKey,2),resp.AirResponsekey
			...
			and ISNULL(resp.gdsSourceKey,2) = (Case WHEN @gdssourcekey = 0 THEN ISNULL(resp.gdsSourceKey,2) ELSE @gdssourcekey END ) 
			select 'OW Upsell',* from #AllOneWayResponses
		END
		ELSE
		BEGIN
...
--return
		...
		BEGIN
			INSERT #AllOneWayResponses (airOneResponsekey,airOnePriceBase,airOnePriceBaseSenior ,airOnePriceTaxSenior, airOnePriceBaseChildren ,airOnePriceTaxChildren ,airOnePriceBaseInfant, airOnePriceTaxInfant,airOnePriceBaseYouth, airOnePriceTaxYouth, airOnePriceBaseTotal, airOnePriceTaxTotal,airOnePriceBaseDisplay, airOnePriceTaxDisplay,
			airSegmentFlightNumber,airSegmentMarketingAirlineCode,airsubRequestkey,airOnePriceTax ,airpriceTotal,otherLegprice ,cabinclass ,otherlegtax  ,legConnections,airOnePriceBaseInfantWithSeat, airOnePriceTaxInfantWithSeat,agentwareQueryID,agentwareItineraryID,airLegBrandName,airLegBookingClasses,gdsSourceKey,childResponsekey)  
			SELECT resp.airresponsekey, (airPriceBase + ISNULL(@airPriceForAnotherLeg,0)  ),
			...
			(airPriceTaxInfantWithSeat + ISNULL(@airPriceTaxInfantWithSeatForAnotherLeg,0)),agentwareQueryID,agentwareItineraryID,n.airLegBrandName,n.airLegBookingClasses,ISNULL(resp.gdsSourceKey,2),resp.airresponsekey
			From #NormalizedAirResponses n WITH (NOLOCK) inner join #AirResponse resp WITH (NOLOCK) on n.airresponsekey = resp.airResponseKey WHERE resp.airSubRequestKey = @airSubRequestKey   
			...
			flightNumber,airlines,resp .airSubRequestKey ,(airPriceTax + ISNULL(@airPriceTaxForAnotherLeg,0)),(airPriceBase + ISNULL(@airPriceForAnotherLeg,0)  )+(airPriceTax + ISNULL(@airPriceTaxForAnotherLeg,0)) , case when @isTotalPriceSort = 0 THEN  ISNULL(@airPriceForAnotherLeg,0) else( isnull(@airPriceForAnotherLeg ,0) + isnull(@airPriceTaxForAnotherLeg,0) ) END,n .cabinclass ,isnull(@airPriceTaxForAnotherLeg,0)  ,n.airLegConnections,
			(airPriceBaseInfantWithSeat + ISNULL(@airPriceInfantWithSeatForAnotherLeg,0)  ),
			(airPriceTaxInfantWithSeat + ISNULL(@airPriceTaxInfantWithSeatForAnotherLeg,0)),n.airLegBrandName,n.airLegBookingClasses,resp.airResponseMultiBrandKey,1,ISNULL(resp.gdsSourceKey,2),resp.airresponsekey
			From #NormalizedAirResponsesMultiBrand n WITH (NOLOCK) inner join #AirResponseMultiBrand resp WITH (NOLOCK) on n.airresponseMultiBrandkey = resp.airResponseMultiBrandKey WHERE resp.airSubRequestKey = @airSubRequestKey 
...
--return
	...
	BEGIN
		...
		BEGIN
			...
			/**** KEEP ALL DUPLICATE WITH LOWEST PRICE AND DELETE HIGHER PRICE OF UPSELL FARES ****/
			delete #AllOneWayResponses  
			FROM #AllOneWayResponses t,  
			(  
			...
			/**** KEEP ONLY ONE LOWEST PRICE ,REMOVE ALL OTHER WITH SAME PRICE OF UPSELL FARES ****/
			delete #AllOneWayResponses  
			FROM #AllOneWayResponses t,  
			(  
			SELECT min(airOnePriceBase + airOnePriceTax) AS minPrice,MIN(airOneIdent )  AS minIdent,   airSegmentFlightNumber,airSegmentMarketingAirlineCode,airLegBookingClasses  
			...
			select '0',* from #AllOneWayResponses where isMultiBrandFare = 0
			select '0',* from #AllOneWayResponses where isMultiBrandFare = 1
			--select 'Lowest AllONe',* from #AllOneWayResponses
		END
		...
		BEGIN
			...
			WHERE (S.airsubRequestkey = @airBundledRequest OR S.airsubRequestkey = @airPublishedFareRequest)
...
--return
	...
	BEGIN
		If(@airRequestTypeKey = 1 OR (@airRequestTypeKey = 2 AND @isMultiBrandSelectedOnPreviousLeg = 0))
		BEGIN
			INSERT INTO #AdditionalFares(airResponseKey,airresponseMultiBrandkey,TotalPriceToDisplay,airLegBrandName,TotalAllPaxPriceToDisplay,childresponsekey)
			SELECT t.airOneResponsekey,t.airResponseMultiBrandKey,(t.airOnePriceBaseDisplay + t.airOnePriceTaxDisplay),t.airLegBrandName,(t.airOnePriceBaseTotal + t.airOnePriceTaxTotal),t.childResponsekey
			From #AllOneWayResponses t 
			WHERE t.isMultiBrandFare = 1 AND (t.airsubRequestkey = @airBundledRequest OR t.airsubRequestkey = @airSubRequestKey OR t.airsubRequestkey = @airAgentWareWNRequest)
			ORDER BY t.airOneResponsekey,(t.airOnePriceBaseDisplay + t.airOnePriceTaxDisplay)
			select 'Add',* from #AdditionalFares
		...
		BEGIN
			...
			INSERT INTO #AdditionalFares(airResponseKey,airresponseMultiBrandkey,TotalPriceToDisplay,airLegBrandName,TotalAllPaxPriceToDisplay,childresponsekey)
			SELECT TM.airOneResponsekey,TM.airResponseMultiBrandKey,(TM.airOnePriceBaseDisplay + TM.airOnePriceTaxDisplay),TM.airLegBrandName,(TM.airOnePriceBaseTotal + TM.airOnePriceTaxTotal),TM.childResponsekey
			From #AllOneWayResponses t
			INNER JOIN @Temp_AllOneWayResponses TM
			ON t.airOneResponsekey = TM.airOneResponsekey 
			WHERE (TM.airsubRequestkey = @airBundledRequest OR TM.airsubRequestkey = @airSubRequestKey OR TM.airsubRequestkey = @airPublishedFareRequest OR t.airsubRequestkey = @airAgentWareWNRequest)
...
--return
	...
	BEGIN
		...
		BEGIN
		--SELECT '1'
		--SELECT COUNT(*) FROM #airResponseResultset where airResponseMultiBrandkey IS NOT NULL
		    --select * from #airResponseResultset where airResponseMultiBrandkey IS NOT NULL 
			...
			WHERE airLegNumber = @airRequestTypeKey AND (ARMB.airSubRequestKey = @airBundledRequest OR ARMB.airSubRequestKey = @airSubRequestKey OR ARMB.airSubRequestKey = @airPublishedFareRequest)
	...
	BEGIN
		...
		WHERE airresponsekey IN (SELECT A.airResponseKey from #airResponseResultset A WHERE (case when @isTotalPriceSort= 0 then A.airPrice  else A.totalcost end) > @MaxDomesticFareTotal)
		-- Upsell fares Also to be deleted
		select 'LAst',* from #AdditionalFares
		--return
		IF(@isMultiBrand = 1)
		BEGIN
		DELETE FROM #AdditionalFares 
		WHERE airresponseMultiBrandkey IN (SELECT A.airResponseMultiBrandkey from #AdditionalFares A WHERE (case when @isTotalPriceSort= 0 then Round((A.TotalPriceToDisplay),2)  else 
		Round((A.TotalAllPaxPriceToDisplay),2) end) > Round((@MaxDomesticFareTotal),2))
		END
		select 'LAst 1',* from #AdditionalFares
		--SELECT * from #AdditionalFares
		--return
		--DELETE FROM #AdditionalFares 
		--WHERE airresponseMultiBrandkey IN (SELECT A.airResponseMultiBrandkey from #AirResponseMultiBrand A WHERE (case when @isTotalPriceSort= 0 then (A.airPriceBaseDisplay + a.airPriceTaxDisplay)  else 
		--(A.airPriceBaseTotal + A.airPriceTaxTotal) end) > @MaxDomesticFareTotal)	
	END
	...
	SELECT airresponseMultiBrandkey,airLegBrandName,TotalPriceToDisplay,childresponsekey FROM #AdditionalFares A
