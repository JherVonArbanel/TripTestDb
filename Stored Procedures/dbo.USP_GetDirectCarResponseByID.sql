...
SET ANSI_NULLS ON
GO
--exec USP_GetDirectCarResponseByID '2c4b76c7-0e35-4536-a18f-8f59fdc2c375'
CREATE PROCEDURE [dbo].[USP_GetDirectCarResponseByID]  
...
FROM    
	...
	AND upper(DR.carResponseKey) = upper (@CarResponseKey)AND DR.carCategoryCode = CD.carCategoryCode
