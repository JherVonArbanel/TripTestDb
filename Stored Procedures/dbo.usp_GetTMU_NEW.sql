...
-- EXEC usp_GetTMU_NEW 'DFW','From' ,5,48,0,1,0,'08/01/2014',0,'','',3,0, 1, 48
-- 560812

CREATE PROC [dbo].[usp_GetTMU_NEW]
(
...
#################################################################################### */
	...
	BEGIN 	
		...
		AND T1.IsWatching = 1
		AND T1.startDate > DATEADD(D,2, GetDate()) -- DOD STOPS BEFORE TWO DAYS OF TRIP START DATE ....		
