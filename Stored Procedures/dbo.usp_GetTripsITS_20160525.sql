...
-- =============================================                         
CREATE PROCEDURE [dbo].[usp_GetTripsITS_20160525] 
--DECLARE	
...
BEGIN 
	...
	--SELECT @pageName=N'Currenttrips',@pageNo=1,@userkey=7816,@tripKey=NULL,@fromDate=N'2016-2-28',@toDate=N'2016-6-28',@traveler=NULL,@status=NULL,@companyKey=245,@TripCompType=N'Trip',@totalRecords=5 ,@siteKey=9,@sortField=N'Traveler',@sortDirection=N'Ascending'	
...
--SELECT GETDATE() AS [0.4] 
	...
	BEGIN                            
		...
		FROM trip WITH(NOLOCK)               
			...
			LEFT OUTER JOIN TripCarResponse TCR WITH (NOLOCK) ON trip.tripPurchasedKey = TCR.tripGUIDKey  AND TCR.tripKey IS NOT NULL      
