...
create procedure [dbo].[RFP_OneWorldDetailReport_test]    
(    
 @userKey int,    
 @currency varchar(5),    
 @meetingCode int,    
...
*/
 ...
 Select trip.tripKey,
 trip.recordLocator
 ,CONVERT(DATE, trip.CreatedDate, 103) as bookedDate, CONVERT(DATE, trip.startDate, 103) as TravelDate,       
