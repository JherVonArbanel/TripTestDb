...
--sp_helptext usp_GetTripDetailsForMultipax   
           
/*Exec usp_GetTripDetailsForMultipax 7841,0   */                  
CREATE PROCEDURE [dbo].[usp_GetTripDetailsForMultipax_bak_20130802]                          
(                      
 @tripID   int   ,                        
 @tripRequestID Int = 0                        
)                      
...
SELECT TOP 1 @AddCollectAmount = AddCollectFare + serviceCharge FROM TripTicketInfo  TTI  WITH(NOLOCK)           
...
select                  
hotel.*,t.tripKey,GL.AgentURL,HI.SupplierImageURL from vw_TripHotelResponseDetails hotel WITH(NOLOCK)          
