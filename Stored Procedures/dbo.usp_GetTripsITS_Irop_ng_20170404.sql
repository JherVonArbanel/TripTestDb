...
CREATE PROCEDURE [dbo].[usp_GetTripsITS_Irop_ng_20170404] 
--DECLARE
...
--	,@UserGUID=N'A252586E-ED80-443F-BDB9-01AC3F7738E6',@PageName=N'mytrips',@PNR=N'',@UDIDandValue=NULL,@StartDate=NULL,@EndDate=NULL

--SELECT @SiteGUID=N'23354297-8F46-4A78-8F0F-F9800C7E3E7B',@CompanyGUID=N'3E51149C-98AC-480E-9E01-1EBD6E20DB4F'
--	,@UserGUID=N'31E7A8C0-5E72-41D8-B05F-CB19798AD39F',@PageName=N'activetrips',@PNR=N'',@UDIDandValue=NULL,@StartDate=NULL,@EndDate=NULL

--SELECT @SiteGUID=N'23354297-8F46-4A78-8F0F-F9800C7E3E7B',@CompanyGUID=N'299084BA-D3EF-4939-A900-49806158F35E',@UserGUID=N'C36D1A30-1329-4D78-AD31-64F3BFD57B36',@PageName=N'activetrips',@PNR=N'',@UDIDandValue=NULL,@StartDate=NULL,@EndDate=NULL
BEGIN
...
--SELECT @SiteGUID, @siteKey, @GroupKey 
				...
				FROM	trip WITH(NOLOCK)               
						...
						LEFT OUTER JOIN Vault.dbo.Meeting MET ON MET.Meetingcodekey = Att.Meetingcodekey and MET.companykey = @companyKEy
